...
@__DSOCacheEntry_name.7 = internal constant [16 x i8] c"libLdaNative.so\00", align 1
@__DSOCacheEntry_name.8 = internal constant [24 x i8] c"libonnxruntime4j_jni.so\00", align 1
@__DSOCacheEntry_name.9 = internal constant [16 x i8] c"libSkiaSharp.so\00", align 1
@__DSOCacheEntry_name.10 = internal constant [32 x i8] c"libmono-component-hot_reload.so\00", align 1
@__DSOCacheEntry_name.11 = internal constant [25 x i8] c"libtensorflowlite_jni.so\00", align 1
@__DSOCacheEntry_name.12 = internal constant [35 x i8] c"libSystem.IO.Compression.Native.so\00", align 1
...
@dso_cache = local_unnamed_addr global [52 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 12
	%struct.DSOCacheEntry {
